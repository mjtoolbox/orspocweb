...
$(document).click(function (e){
    ...
    if ($('[data-toggle=offcanvas]').is(e.target)
...
$(document).ready(function() {
    //menu expand and collapse
  	$('.tree-toggler').click(function(e) {
		...
		$(this).children('.fa').toggleClass('blue-1 blue-2');
	});
    //global search icon
    ...
    //global search form clear button
    $('.search-clear').click(function(e) {
        $('.search-form input[type="text"]').val('').focus();
    });
    //closing search form if clicked outside
    ...
    //faq icon expand and collapse
	$('.faq .panel-title a').click(function(e){
		$(this).children('.fa').toggleClass('fa-plus fa-minus');
	});

    //homepage expand collapse components
	$('.home .panel-title a').click(function(e){
		$(this).children('.fa').toggleClass('fa-caret-down fa-caret-up');
	});
    ...
    //     $('.outages-address input[type="text"]').focus();
    // });

});
$(document).ready(function() {
    $('a').click(function(e) {
        if ((this.href && this.href.match(/\/modals/))) {
                e.preventDefault();
            if ($("#myModal").data("href") != this.href)
                $("#myModal").removeData('bs.modal');
            $("#myModal").data("href", this.href);
                $("#myModal").modal({
                    remote : this.href
            });
        }
...
$(document).ready(function() {
    var cookieValue = $.cookie('BCHydroMobile');
    if (typeof cookieValue != 'undefined'){
        var expires = new Date();
        expires.setMinutes(expires.getMinutes() + 30);

        $.cookie('BCHydroMobile', cookieValue, { path: '/', expires : expires });
...
$(document).ready(function() {
    //detecting android and adding class to body
